...
var _Info = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./Info\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
var Login = function (_Component) {
  ...
  _createClass(Login, [{
    ...
    value: function componentDidMount() {
      ...
      _axios2.default.get('/' + APP_NAME + '/lottery').then(function (_ref) {
        var data = _ref.data;
        var code = data.code,
            all = data.data;
    ...
    value: function login(isLogin) {
      ...
      _axios2.default.get('/' + APP_NAME + '/login?name=' + name + '&password=' + pwd).then(function (_ref2) {
        var data = _ref2.data;
