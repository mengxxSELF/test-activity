...
var _Lottery = __webpack_require__(101);

var _Lottery2 = _interopRequireDefault(_Lottery);

var _Info = __webpack_require__(102);
...
var Login = function (_Component) {
  ...
  _createClass(Login, [{
    ...
    value: function login(isLogin) {
      ...
      var name = (0, _jquery2.default)('input[placeholder=name]').val() || '';
      var pwd = (0, _jquery2.default)('input[placeholder=Password]').val() || '';

      _axios2.default.get('/' + APP_NAME + '/login?name=' + name + '&password=' + pwd).then(function (_ref) {
        var data = _ref.data;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', { className: 'form-control', placeholder: 'name' })
        ),
        _react2.default.createElement(
          'div',
          { className: 'form-group' },
...
var Info = function (_Component) {
  ...
  function Info() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Info.__proto__ || Object.getPrototypeOf(Info)).call.apply(_ref, [this].concat(args))), _this), _this.state = { all: [] }, _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Info, [{
    ...
    value: function componentDidMount() {
      ...
      _axios2.default.get('/' + APP_NAME + '/lottery').then(function (_ref2) {
        var data = _ref2.data;
        var code = data.code,
            all = data.data;
        ...
        _react2.default.createElement(
          ...
          data && data.length > 0 && data.map(function (item, index) {
            return _react2.default.createElement(
              'p',
              { key: index },
              '\u606D\u559C ' + item['name'] + ' \u6293\u5230 \u6731\u4E00\u9F99 ' + item['number'] + ' \u53F7',
              ' '
            );
          })
        )
